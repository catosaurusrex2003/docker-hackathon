...
export default function Home() {
  ...
  return (
    <main className="mx-auto mt-16 w-fit">
      <h1 className="text-lg text-center my-2 mb-10">Stamp Detection</h1>
      <div className="flex justify-between">
        ...
        <div className="ml-10">
          ...
          {data?.does_exist && (
            <p className="text my-1 text-green-800 py-2 w-full text-center bg-green-200 rounded-lg">
              Stamps Exists
            </p>
          )}
          {data?.unique && (
            <p className="text my-1 text-green-800 py-2 w-full text-center bg-green-200 rounded-lg">
              {data?.unique} Unique Stamps Found
            </p>
          )}
        </div>
      </div>
